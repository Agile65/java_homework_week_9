...
public class Program_2_MarkSheet {
    public static void main(String[] args) {
        ...
        if(mathsMarks < 0 || mathsMarks > 100) {
                ...
                System.out.println("\nPlease enter correct Maths marks\t \t:\t");
        ...
        if (scienceMarks < 0 || scienceMarks > 100) {
            System.out.println("\n Invalid input, Marks should between 0 to 100");
            System.out.println("\nPlease enter correct Science marks\t \t:\t");
        ...
        if (englishMarks < 0 || englishMarks > 100) {
            System.out.println("\n Invalid input, Marks should between 0 to 100");
            System.out.println("\nPlease enter correct English marks\t \t:\t");
    ...
    public static void printTheMarkSheet(String name,int rollNum,int mathsMarks,int scienceMarks,int englishMarks,int total,int percentage,String result,String grade){
        System.out.println("-----------------------------");
        System.out.println("|                           |");
